...
const readingExercises = [
  ...
  },
  {
    ...
    vocab: [
      { word: "あさごはん", meaning: "sarapan" },
      { word: "いつも", meaning: "selalu" },
      { word: "パン", meaning: "roti" },
      { word: "たまご", meaning: "telur" },
      { word: "のみます", meaning: "minum" },
    ],
    questions: [
      { q: "Apa yang dia minum saat sarapan?", options: ["Teh", "Susu", "Air putih", "Kopi"], correct: 3 },
    ],
  },
  ...
  // N4
  {
    ...
    vocab: [
      { word: "お元気ですか", meaning: "Apa kabar?" },
      { word: "住んでいます", meaning: "sedang tinggal" },
      { word: "お寺", meaning: "kuil (Buddha)" },
      { word: "食事をしませんか", meaning: "maukah makan?" },
      { word: "お返事", meaning: "balasan" },
    ],
    questions: [
      { q: "Di mana Suzuki tinggal sekarang?", options: ["Tokyo", "Osaka", "Kyoto", "Nara"], correct: 2 },
      { q: "Apa yang ingin dilakukan Suzuki bulan depan?", options: ["Pergi ke kuil", "Makan bersama Tanaka di Tokyo", "Pindah ke Tokyo", "Bekerja di Tokyo"], correct: 1 },
    ],
  },
  {
    id: 5,
    ...
    vocab: [
      { word: "日記", meaning: "buku harian" },
      { word: "貝を拾う", meaning: "memungut kerang" },
      { word: "海辺", meaning: "tepi laut" },
      { word: "新鮮", meaning: "segar" },
    ],
    questions: [
      { q: "Apa yang TIDAK dia lakukan di laut?", options: ["Berenang", "Memancing", "Memungut kerang", "Makan kaisendon"], correct: 1 },
    ],
  },
  ...
  // N3
  {
    ...
    vocab: [
      { word: "地域", meaning: "daerah" },
      { word: "異なる", meaning: "berbeda" },
      { word: "燃えるゴミ", meaning: "sampah yang bisa dibakar" },
      { word: "資源", meaning: "sumber daya/daur ulang" },
      { word: "収集", meaning: "pengumpulan" },
    ],
    questions: [
      { q: "Apa yang terjadi jika tidak mematuhi aturan membuang sampah?", options: ["Didenda uang", "Sampah tidak diambil", "Harus pindah rumah", "Polisi akan datang"], correct: 1 },
    ],
  },
  {
    id: 7,
    ...
    vocab: [
      { word: "普及", meaning: "penyebaran/populer" },
      { word: "連絡を取る", meaning: "berkomunikasi" },
      { word: "増加", meaning: "peningkatan" },
      { word: "社会問題", meaning: "masalah sosial" },
    ],
    questions: [
      { q: "Apa dampak negatif dari penyebaran smartphone yang disebutkan teks?", options: ["Harga barang naik", "Kecelakaan 'berjalan sambil main smartphone'", "Orang jarang keluar rumah", "Masalah mata berkurang"], correct: 1 },
    ],
  },
  ...
  // N2
  {
    ...
    vocab: [
      { word: "削減", meaning: "pengurangan/pemangkasan" },
      { word: "浮き彫りになる", meaning: "menjadi jelas/sorotan" },
      { word: "孤独感", meaning: "rasa kesepian" },
      { word: "対策を講じる", meaning: "mengambil tindakan" },
    ],
    questions: [
      { q: "Siapa yang disebut paling rentan merasakan kesepian karena telework?", options: ["Manajer", "Karyawan senior", "Karyawan baru", "Presiden direktur"], correct: 2 },
      { q: "Apa langkah yang diambil perusahaan?", options: ["Mengurangi gaji", "Menyediakan obrolan online", "Mewajibkan masuk kantor", "Mengurangi jam kerja"], correct: 1 },
    ],
  },
  ...
  // N1
  {
    ...
    vocab: [
      { word: "不可逆的", meaning: "ireversibel/tidak bisa dibalik" },
      { word: "変容", meaning: "transformasi/perubahan" },
      { word: "必然の理", meaning: "hukum alam/pasti terjadi" },
      { word: "排斥", meaning: "penolakan/pemboikotan" },
      { word: "補完", meaning: "saling melengkapi" },
      { word: "局面", meaning: "fase/situasi" },
    ],
    questions: [
      { q: "Menurut teks, apa yang dituntut dari manusia di era AI?", options: ["Kemampuan pemrograman", "Keterampilan kreatif dan interpersonal tingkat tinggi", "Kemampuan melakukan pekerjaan rutin dengan cepat", "Menolak AI secara total"], correct: 1 },
    ],
  }
];

const fileContent = `export interface VocabItem {
  word: string;
  meaning: string;
}
...
export const readingData: ReadingPassage[] = ${JSON.stringify(readingExercises, null, 2)};
`;

const outputPath = path.join(__dirname, "..", "src", "lib", "readingData.ts");
fs.writeFileSync(outputPath, fileContent, "utf-8");
console.log("✅ Berhasil men-generate readingData.ts dengan", readingExercises.length, "latihan reading!");
