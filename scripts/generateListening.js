...
const listeningExercises = [
  // N5
  {
    ...
    questions: [
      { q: "Berapa umur Yuka Sato?", options: ["21 tahun", "22 tahun", "23 tahun", "24 tahun"], correct: 2 },
    ],
  },
  {
    id: 2,
    ...
    questions: [
      { q: "Berapa orang tamu yang datang ke restoran?", options: ["1 orang", "2 orang", "3 orang", "4 orang"], correct: 1 },
    ],
  },
  {
    id: 3,
    ...
    questions: [
      { q: "Kereta akan berangkat dari peron nomor berapa?", options: ["Peron 1", "Peron 2", "Peron 3", "Peron 4"], correct: 2 },
    ],
  },
  ...
  // N4
  {
    ...
    questions: [
      { q: "Apa yang harus dibawa saat keluar rumah besok?", options: ["Payung", "Kacamata hitam", "Jas", "Topi"], correct: 0 },
    ],
  },
  {
    id: 5,
    ...
    questions: [
      { q: "Jam berapa rapat akan dimulai?", options: ["Jam 1", "Jam 2", "Jam 3", "Jam 4"], correct: 2 },
    ],
  },
  {
    id: 6,
    ...
    questions: [
      { q: "Apa yang akan dia lakukan pada hari Minggu?", options: ["Nonton film", "Istirahat di rumah", "Bertemu teman", "Belanja"], correct: 1 },
    ],
  },
  ...
  // N3
  {
    ...
    questions: [
      { q: "Berapa lama penerbangan tersebut terlambat?", options: ["10 menit", "20 menit", "30 menit", "1 jam"], correct: 2 },
    ],
  },
  {
    id: 8,
    ...
    questions: [
      { q: "Selain masakan yang enak, apa alasan lain restoran itu populer?", options: ["Harganya murah", "Lokasinya strategis", "Pelayanan stafnya bagus", "Buka 24 jam"], correct: 2 },
    ],
  },
  ...
  // N2
  {
    ...
    questions: [
      { q: "Berapa persen peningkatan nilai ekspor mobil tahun lalu?", options: ["2%", "5%", "10%", "15%"], correct: 1 },
    ],
  },
  {
    id: 10,
    ...
    questions: [
      { q: "Mengapa tanggal rilis produk ditunda?", options: ["Kekurangan dana", "Masalah pemasaran", "Keterlambatan pengembangan", "Kekurangan bahan baku"], correct: 2 },
    ],
  },
  ...
  // N1
  {
    ...
    questions: [
      { q: "Menurut audio, apa yang lebih dipentingkan oleh konsumen modern selain harga murah?", options: ["Kualitas produk", "Merek produk", "Dampak lingkungan", "Kecepatan pengiriman"], correct: 2 },
    ],
  }
];

const fileContent = `export interface ListeningQuestion {
  q: string;
  options: string[];
  correct: number;
}
...
export const listeningData: ListeningExercise[] = ${JSON.stringify(listeningExercises, null, 2)};
`;

const outputPath = path.join(__dirname, "..", "src", "lib", "listeningData.ts");
fs.writeFileSync(outputPath, fileContent, "utf-8");
console.log("✅ Berhasil men-generate listeningData.ts dengan", listeningExercises.length, "latihan listening!");
